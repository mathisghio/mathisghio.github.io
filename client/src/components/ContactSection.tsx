      ...
      <section id="contact" ref={ref} style={{ background: '#08090E' }}>
        ...
        <LampContainer className="min-h-[58vh] lg:min-h-[80vh] lamp-lower-desktop">
          ...
          >
            ...
            <h2 className="font-display leading-none text-white" style={{ fontSize: 'clamp(48px, 8vw, 110px)' }}>TOUCH</h2>
          </motion.div>
        </LampContainer>

        <div className="container relative z-10 pb-2 lg:pb-10 -mt-[140px] lg:mt-[28px]">
          <div

    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{ background: 'linear-gradient(180deg, #08090E 0%, transparent 12%, transparent 88%, #08090E 100%)' }}
        />
        <div
          className="absolute inset-0 z-[1] pointer-events-none"
          style={{ background: 'linear-gradient(90deg, #08090E 0%, transparent 8%, transparent 92%, #08090E 100%)' }}
        />

        {/* Radial glow au centre */}
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] pointer-events-none z-[2]"
        ...
        <div className="container relative z-10">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="font-body text-xs uppercase tracking-widest" style={{ color: '#0EA5E9', letterSpacing: '0.2em' }}>Contact</span>
            </div>
            ...
            >
              For partnerships, media inquiries, professional opportunities and collaboration. Open to brand collaborations, media features and performance-driven projects.
            </p>
          </div>
          ...
          <div
            ...
            style={{ opacity: inView ? 1 : 0, transform: inView ? 'translateY(0)' : 'translateY(20px)', transitionDelay: '500ms' }}
          >
            ...
            <a
              ...
              style={{ fontSize: 'clamp(24px, 4vw, 48px)', textDecoration: 'none', letterSpacing: '0.02em' }}
            >

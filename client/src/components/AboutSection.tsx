      ...
      <div className="container relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-8 transition-all relative z-10" style={{ opacity: inView ? 1 : 0, transform: inView ? 'translateX(0)' : 'translateX(-40px)', transitionDelay: '100ms', transitionDuration: '800ms', transitionTimingFunction: 'cubic-bezier(0.16, 1, 0.3, 1)' }}>
            ...
            {[
              ...
              { text: "Member of the French Elite Athlete list since 2017. Materials Science Engineering at INSA Lyon (Sport-Study) — a rare combination of elite athletics and hard-science expertise that makes every R&D partnership credible.", delay: '400ms' },
            ...
            <div className="mt-8 py-5 px-5 transition-all duration-700" style={{ background: 'rgba(14,165,233,0.04)', borderTop: '1px solid rgba(14,165,233,0.18)', borderBottom: '1px solid rgba(14,165,233,0.18)', opacity: inView ? 1 : 0, transitionDelay: '600ms', transitionTimingFunction: 'cubic-bezier(0.16, 1, 0.3, 1)' }}>
            ...
            <div className="mt-10 grid grid-cols-3 gap-4 transition-all duration-700" style={{ opacity: inView ? 1 : 0, transform: inView ? 'translateY(0)' : 'translateY(32px)', transitionDelay: '700ms', transitionTimingFunction: 'cubic-bezier(0.16, 1, 0.3, 1)' }}>
          ...
          <div className="relative z-10 transition-all" style={{ opacity: inView ? 1 : 0, transform: inView ? 'translateX(0)' : 'translateX(64px)', transitionDelay: '150ms', transitionDuration: '1000ms', transitionTimingFunction: 'cubic-bezier(0.16, 1, 0.3, 1)' }}>
            ...
            <div className="absolute -top-4 -right-4 px-4 py-3 rounded-sm hidden lg:block" style={{ background: 'rgba(8, 9, 14, 0.9)', border: '1px solid rgba(245, 158, 11, 0.4)', boxShadow: '0 0 25px rgba(245, 158, 11, 0.15)' }}>

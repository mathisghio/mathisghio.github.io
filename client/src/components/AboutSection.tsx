        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center relative z-10">
          <div className="relative z-10">
            ...
            {[
              ...
              { text: "Member of the French Elite Athlete list since 2017. Materials Science Engineering student at INSA Lyon, Sport-Study track. Engineering applied directly to performance.", delay: '400ms' },

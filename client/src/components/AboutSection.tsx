...
export function AboutSection() {
  ...
  return (
    <section id="about" ref={ref} className="relative py-14 lg:py-36 overflow-hidden" style={{ background: 'linear-gradient(180deg, #08090E 0%, #0A0F1A 50%, #08090E 100%)' }}>
      <div className="absolute inset-0 z-0" style={{ backgroundImage: `url(${HERO_IMG})`, backgroundSize: 'cover', backgroundPosition: '30% center', opacity: 0.25, filter: 'saturate(0.5)' }} />
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-24 items-center relative z-10">
          <div className="relative z-10">
            ...
            <div className="mt-6 lg:mt-10 grid grid-cols-3 gap-4 transition-all duration-700" style={{ opacity: inView ? 1 : 0, transform: inView ? 'translateY(0)' : 'translateY(32px)', transitionDelay: '700ms', transitionTimingFunction: 'cubic-bezier(0.16, 1, 0.3, 1)' }}>
              {[{ value: '5×', label: 'World Champion', gold: true }, { value: '4×', label: 'European Champion', gold: false }, { value: '41.4 kts', label: 'Speed Record', gold: false }].map((stat, i) => (

...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 bottom-0 hidden sm:flex flex-col justify-center gap-2 pl-6 pointer-events-none" style={{ zIndex: 35 }}>
        {[...Array(5)].map((_, i) => (
      ...
      {/* ═══════════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════════ */}
      <div
        className="absolute inset-x-0 z-40 hidden sm:grid overflow-hidden"
      ...
      <div
        className="absolute inset-x-0 z-40 flex sm:hidden flex-col"
      ...
      <div
        className="absolute inset-x-0 bottom-0 z-40 flex sm:hidden flex-col"
      ...
      <div
        className="absolute bottom-0 left-0 right-0 z-40 hidden sm:block transition-all duration-700"
        style={{
          opacity:         visible ? 1 : 0,

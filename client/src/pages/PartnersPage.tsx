        ...
        <div style={{ paddingTop: '56px', paddingBottom: '56px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '16px' }}>
            {[
              ...
              { icon: '🌍', title: 'Global Reach', body: '12 international competitions across 3 continents — Europe, Asia, and the Americas. On-site brand visibility at every major wingfoil championship.' },
